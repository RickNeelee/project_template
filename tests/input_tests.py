...
class TestInputFunctions(unittest.TestCase):
    ...
    def test_input_from_file_returns_string(self):         # Test if the function returns a string
        file_text = input_from_file("C:/Users/Asus/PycharmProjects/project_template/data/file_input.txt")
    ...
    def test_input_from_file_pandas_returns_dataframe(self):        # Test if the function returns a DataFrame
        file_data = input_from_file_pandas("C:/Users/Asus/PycharmProjects/project_template/data/pandas_data.csv")
        import pandas as pd
